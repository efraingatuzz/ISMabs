...
! 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
subroutine ismabsargon(ear, ne, param, ifl, photar)
!
...
version='1.0'
 if(startup)then
  ...
  print *, ' '
  call read_cross_sections_ismabsargon( nemod,bxs,ifl)
  call create_energy_grid_ismabsargon(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
! Model parameters
N_N_1 = param(1)
...
call absorption_ismabsargon(N_N_1, N_N_2, &
...
call map_to_grid_ismabsargon(dble(ear),ne,emod,nemod,photar,coemod,ifl)
return
end subroutine ismabsargon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections_ismabsargon(bnene, xs, ifl)
  !---------------------------------------------------------------------
  ! Reads all cross sections and maps them onto a defined energy grid.
  ! Looks for the file at:
  !     <ismabsargon_root>/atomic_data/AtomicData.fits
  !---------------------------------------------------------------------
  ...
  character(len=1024) :: local_dir1, local_dir2, ismabsargon_root, filename2
  ...
  local_dir2 = 'smabs.argon.dev'
  ismabsargon_root = trim(local_dir1) // trim(local_dir2)
  filename2 = trim(ismabsargon_root) // fileloc
...
end subroutine read_cross_sections_ismabsargon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine absorption_ismabsargon(N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6,  N_N_7, &
...
end subroutine absorption_ismabsargon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine map_to_grid_ismabsargon(new_en, nne, old_en, one, nflux, old_flu, ifl)
  ...
  do i = 1, nne
     ...
     call dbinsrch_ismabsargon(new_en(i - 1), bmin, old_en, one + 1)
     call dbinsrch_ismabsargon(new_en(i), bmax, old_en, one + 1)
     bmin = bmin - 1
     bmax = bmax - 1
...
end subroutine map_to_grid_ismabsargon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine dbinsrch_ismabsargon(e, k, ener, n)
  ...
  k = klo
end subroutine dbinsrch_ismabsargon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine create_energy_grid_ismabsargon(emin, emax, en, nen)
...
end subroutine create_energy_grid_ismabsargon
