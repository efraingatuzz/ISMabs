...
! 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
subroutine ismabsne(ear, ne, param, ifl, photar)
!
...
version='1.0'
 if(startup)then
  ...
  print *, ' '
  call read_cross_sections_ismabsne( nemod,bxs,ifl)
  call create_energy_grid_ismabsne(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
! Model parameters
N_N_1 = param(1)
...
call absorption_ismabsne(N_N_1, N_N_2, &
N_N_3, N_N_4, N_N_5, N_N_6, N_N_7, N_N_8, & 
N_N_9, N_N_10, & 
zfac, emod, nemod, coemod,bxs,cion,ifl,bener)

call map_to_grid_ismabsne(dble(ear),ne,emod,nemod,photar,coemod,ifl)
return
end subroutine ismabsne

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections_ismabsne(bnene, xs, ifl)
  !---------------------------------------------------------------------
  ...
  character(len=1024) :: local_dir1, local_dir2, ismabsne_root, filename2
...
end subroutine read_cross_sections_ismabsne

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine absorption_ismabsne(N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6,  N_N_7, &
				  N_N_8, N_N_9, N_N_10, &
...
end subroutine absorption_ismabsne

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine map_to_grid_ismabsne(new_en, nne, old_en, one, nflux, old_flu, ifl)
  ...
  do i = 1, nne
     ...
     call dbinsrch_ismabsne(new_en(i - 1), bmin, old_en, one + 1)
     call dbinsrch_ismabsne(new_en(i), bmax, old_en, one + 1)
     bmin = bmin - 1
     bmax = bmax - 1
...
end subroutine map_to_grid_ismabsne

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine dbinsrch_ismabsne(e, k, ener, n)
  ...
  k = klo
end subroutine dbinsrch_ismabsne

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine create_energy_grid_ismabsne(emin, emax, en, nen)
...
end subroutine create_energy_grid_ismabsne
