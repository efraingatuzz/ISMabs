...
! ismabscarbon
! ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
! XSPEC local model for ISM absorption due to carbon
! Version 1.0 July 2025 
!
! - This version only has CI-CVI as free parameters. 
! 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
subroutine ismabscarbon(ear, ne, param, ifl, photar)
!
! The main routine to call all subroutines
!
implicit none
integer,parameter :: num_param = 7, out_unit=20, nion=6
...
double precision :: N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6 
...
version='1.0'
 if(startup)then
  print *, ' '
  print *, 'ISMabs_carbon: ISM absorption model Version ',version 
  print *, 'NOTE: this model does not include hydrogen or helium, only C'       
  print *, ' '
  call read_cross_sections_ismabscarbon( nemod,bxs,ifl)
  call create_energy_grid_ismabscarbon(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
! Model parameters
N_N_1 = param(1)
...
call absorption_ismabscarbon(N_N_1, N_N_2, &
  N_N_3, N_N_4, N_N_5, N_N_6, & 
zfac, emod, nemod, coemod,bxs,cion,ifl,bener)

call map_to_grid_ismabscarbon(dble(ear),ne,emod,nemod,photar,coemod,ifl)
return
end subroutine ismabscarbon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections_ismabscarbon(bnene, xs, ifl)
  !---------------------------------------------------------------------
  ! Reads all cross sections and maps them onto a defined energy grid.
  ! Looks for the file at:
  !     <ismabscarbon_root>/atomic_data/AtomicData.fits
  !---------------------------------------------------------------------

  implicit none
  integer, parameter :: nion = 6, out_unit = 20
  ...
  character(len=1024) :: local_dir1, local_dir2, ismabscarbon_root, filename2
  ...
  local_dir2 = 'smabs.carbon.dev'
  ismabscarbon_root = trim(local_dir1) // trim(local_dir2)
  filename2 = trim(ismabscarbon_root) // fileloc
...
end subroutine read_cross_sections_ismabscarbon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine absorption_ismabscarbon(N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6, &
  ...
  double precision, intent(in) :: N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6
...
end subroutine absorption_ismabscarbon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine map_to_grid_ismabscarbon(new_en, nne, old_en, one, nflux, old_flu, ifl)
  ...
  do i = 1, nne
     ...
     call dbinsrch_ismabscarbon(new_en(i - 1), bmin, old_en, one + 1)
     call dbinsrch_ismabscarbon(new_en(i), bmax, old_en, one + 1)
     bmin = bmin - 1
     bmax = bmax - 1
...
end subroutine map_to_grid_ismabscarbon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine dbinsrch_ismabscarbon(e, k, ener, n)
  ...
  k = klo
end subroutine dbinsrch_ismabscarbon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine create_energy_grid_ismabscarbon(emin, emax, en, nen)
...
end subroutine create_energy_grid_ismabscarbon
