...
! 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
subroutine ismabsn(ear, ne, param, ifl, photar)
!
...
version='1.0'
 if(startup)then
  ...
  print *, ' '
  call read_cross_sections_ismabsn( nemod,bxs,ifl)
  call create_energy_grid_ismabsn(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
! Model parameters
N_N_1 = param(1)
...
call absorption_ismabsn(N_N_1, N_N_2, &
  N_N_3, N_N_4, N_N_5, N_N_6, N_N_7, & 
zfac, emod, nemod, coemod,bxs,cion,ifl,bener)

call map_to_grid_ismabsn(dble(ear),ne,emod,nemod,photar,coemod,ifl)
return
end subroutine ismabsn

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections_ismabsn(bnene, xs, ifl)
  !---------------------------------------------------------------------
  ! Reads all cross sections and maps them onto a defined energy grid.
  ! Looks for the file at:
  !     <ismabsn_root>/atomic_data/AtomicData.fits
  !---------------------------------------------------------------------
  ...
  character(len=1024) :: local_dir1, local_dir2, ismabsn_root, filename2
  ...
  local_dir2 = 'smabs.N.dev'
  ismabsn_root = trim(local_dir1) // trim(local_dir2)
  filename2 = trim(ismabsn_root) // fileloc
...
end subroutine read_cross_sections_ismabsn

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine absorption_ismabsn(N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6,  N_N_7, &
...
end subroutine absorption_ismabsn

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine map_to_grid_ismabsn(new_en, nne, old_en, one, nflux, old_flu, ifl)
  ...
  do i = 1, nne
     ...
     call dbinsrch_ismabsn(new_en(i - 1), bmin, old_en, one + 1)
     call dbinsrch_ismabsn(new_en(i), bmax, old_en, one + 1)
     bmin = bmin - 1
     bmax = bmax - 1
...
end subroutine map_to_grid_ismabsn

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine dbinsrch_ismabsn(e, k, ener, n)
  ...
  k = klo
end subroutine dbinsrch_ismabsn

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine create_energy_grid_ismabsn(emin, emax, en, nen)
...
end subroutine create_energy_grid_ismabsn
