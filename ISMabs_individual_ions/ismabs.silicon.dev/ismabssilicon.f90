...
! ismabssilicon
! ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
! XSPEC local model for ISM absorption due to silicon
! Version 1.0 July 2025 
!
! - This version only has CI-CVI as free parameters. 
! 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
subroutine ismabssilicon(ear, ne, param, ifl, photar)
!
! The main routine to call all subroutines
!
implicit none
integer,parameter :: num_param = 15, out_unit=20, nion=14
...
double precision :: N_N_9,N_N_10,N_N_11,N_N_12,N_N_13,N_N_14
...
version='1.0'
 if(startup)then
  print *, ' '
  print *, 'ISMabs_silicon: ISM absorption model Version ',version 
  print *, 'NOTE: this model does not include hydrogen or helium, only Si'       
  print *, ' '
  call read_cross_sections_ismabssilicon( nemod,bxs,ifl)
  call create_energy_grid_ismabssilicon(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
! Model parameters
N_N_1 = param(1)
...
call absorption_ismabssilicon(N_N_1, N_N_2, &
N_N_3, N_N_4, N_N_5, N_N_6, N_N_7, N_N_8, & 
N_N_9, N_N_10, N_N_11, N_N_12,& 
N_N_13, N_N_14,& 
zfac, emod, nemod, coemod,bxs,cion,ifl,bener)

call map_to_grid_ismabssilicon(dble(ear),ne,emod,nemod,photar,coemod,ifl)
return
end subroutine ismabssilicon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections_ismabssilicon(bnene, xs, ifl)
  !---------------------------------------------------------------------
  ! Reads all cross sections and maps them onto a defined energy grid.
  ! Looks for the file at:
  !     <ismabssilicon_root>/atomic_data/AtomicData.fits
  !---------------------------------------------------------------------

  implicit none
  integer, parameter :: nion = 14, out_unit = 20
  ...
  character(len=1024) :: local_dir1, local_dir2, ismabssilicon_root, filename2
  ...
  local_dir2 = 'smabs.silicon.dev'
  ismabssilicon_root = trim(local_dir1) // trim(local_dir2)
  filename2 = trim(ismabssilicon_root) // fileloc
...
end subroutine read_cross_sections_ismabssilicon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine absorption_ismabssilicon(N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6,  N_N_7, &
...
end subroutine absorption_ismabssilicon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine map_to_grid_ismabssilicon(new_en, nne, old_en, one, nflux, old_flu, ifl)
  ...
  do i = 1, nne
     ...
     call dbinsrch_ismabssilicon(new_en(i - 1), bmin, old_en, one + 1)
     call dbinsrch_ismabssilicon(new_en(i), bmax, old_en, one + 1)
     bmin = bmin - 1
     bmax = bmax - 1
...
end subroutine map_to_grid_ismabssilicon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine dbinsrch_ismabssilicon(e, k, ener, n)
  ...
  k = klo
end subroutine dbinsrch_ismabssilicon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine create_energy_grid_ismabssilicon(emin, emax, en, nen)
...
end subroutine create_energy_grid_ismabssilicon
