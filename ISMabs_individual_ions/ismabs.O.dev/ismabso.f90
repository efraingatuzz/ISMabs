...
! 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
subroutine ismabso(ear, ne, param, ifl, photar)
!
...
version='1.0'
 if(startup)then
  ...
  print *, ' '
  call read_cross_sections_ismabso( nemod,bxs,ifl)
  call create_energy_grid_ismabso(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
! Model parameters
N_N_1 = param(1)
...
call absorption_ismabso(N_N_1, N_N_2, &
N_N_3, N_N_4, N_N_5, N_N_6, N_N_7, N_N_8, & 
zfac, emod, nemod, coemod,bxs,cion,ifl,bener)

call map_to_grid_ismabso(dble(ear),ne,emod,nemod,photar,coemod,ifl)
return
end subroutine ismabso

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections_ismabso(bnene, xs, ifl)
  !---------------------------------------------------------------------
  ! Reads all cross sections and maps them onto a defined energy grid.
  ! Looks for the file at:
  !     <ismabso_root>/atomic_data/AtomicData.fits
  !---------------------------------------------------------------------
  use xsfortran
  implicit none
  ...
  character(len=1024) :: local_dir1, local_dir2, ismabso_root, filename2
  ...
  local_dir2 = 'smabs.O/v1.1'
  ismabso_root = trim(local_dir1) // trim(local_dir2)
  filename2 = trim(ismabso_root) // fileloc
...
end subroutine read_cross_sections_ismabso

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine absorption_ismabso(N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6,  N_N_7, &
				  N_N_8, &
...
end subroutine absorption_ismabso

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine map_to_grid_ismabso(new_en, nne, old_en, one, nflux, old_flu, ifl)
  ...
  do i = 1, nne
     ...
     call dbinsrch_ismabso(new_en(i - 1), bmin, old_en, one + 1)
     call dbinsrch_ismabso(new_en(i), bmax, old_en, one + 1)
     bmin = bmin - 1
     bmax = bmax - 1
...
end subroutine map_to_grid_ismabso

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine dbinsrch_ismabso(e, k, ener, n)
  ...
  k = klo
end subroutine dbinsrch_ismabso

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine create_energy_grid_ismabso(emin, emax, en, nen)
...
end subroutine create_energy_grid_ismabso
