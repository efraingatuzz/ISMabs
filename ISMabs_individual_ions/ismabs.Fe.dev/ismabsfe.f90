...
! ismabsfe
! ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
! XSPEC local model for ISM absorption due to iron
! Version 1.0 July 2025 
!
! - This version only has CI-CVI as free parameters. 
! 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
subroutine ismabsfe(ear, ne, param, ifl, photar)
!
! The main routine to call all subroutines
!
implicit none
integer,parameter :: num_param = 27, out_unit=20, nion=26
...
double precision :: N_N_17,N_N_18,N_N_19,N_N_20,N_N_21,N_N_22
double precision :: N_N_23,N_N_24,N_N_25,N_N_26
...
version='1.0'
 if(startup)then
  print *, ' '
  print *, 'ISMabs_iron: ISM absorption model Version ',version 
  print *, 'NOTE: this model does not include hydrogen or helium, only Fe'       
  print *, ' '
  call read_cross_sections_ismabsfe( nemod,bxs,ifl)
  call create_energy_grid_ismabsfe(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
! Model parameters
N_N_1 = param(1)
...
call absorption_ismabsfe(N_N_1, N_N_2, &
N_N_3, N_N_4, N_N_5, N_N_6, N_N_7, N_N_8, & 
N_N_9, N_N_10, N_N_11, N_N_12,& 
N_N_13, N_N_14, N_N_15, N_N_16,& 
N_N_17, N_N_18, N_N_19, N_N_20,& 
N_N_21, N_N_22, N_N_23, N_N_24,& 
N_N_25, N_N_26,& 
zfac, emod, nemod, coemod,bxs,cion,ifl,bener)

call map_to_grid_ismabsfe(dble(ear),ne,emod,nemod,photar,coemod,ifl)
return
end subroutine ismabsfe

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections_ismabsfe(bnene, xs, ifl)
  !---------------------------------------------------------------------
  ! Reads all cross sections and maps them onto a defined energy grid.
  ! Looks for the file at:
  !     <ismabsfe_root>/atomic_data/AtomicData.fits
  !---------------------------------------------------------------------

  implicit none
  integer, parameter :: nion = 26, out_unit = 20
  ...
  character(len=1024) :: local_dir1, local_dir2, ismabsfe_root, filename2
  ...
  local_dir2 = 'smabs.Fe.dev'
  ismabsfe_root = trim(local_dir1) // trim(local_dir2)
  filename2 = trim(ismabsfe_root) // fileloc
...
end subroutine read_cross_sections_ismabsfe

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine absorption_ismabsfe(N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6,  N_N_7, &
  ...
  double precision, intent(in) :: N_N_15, N_N_16, N_N_17, N_N_18, N_N_19, N_N_20
  double precision, intent(in) :: N_N_21, N_N_22, N_N_23, N_N_24, N_N_25, N_N_26
...
end subroutine absorption_ismabsfe

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine map_to_grid_ismabsfe(new_en, nne, old_en, one, nflux, old_flu, ifl)
  ...
  do i = 1, nne
     ...
     call dbinsrch_ismabsfe(new_en(i - 1), bmin, old_en, one + 1)
     call dbinsrch_ismabsfe(new_en(i), bmax, old_en, one + 1)
     bmin = bmin - 1
     bmax = bmax - 1
...
end subroutine map_to_grid_ismabsfe

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine dbinsrch_ismabsfe(e, k, ener, n)
  ...
  k = klo
end subroutine dbinsrch_ismabsfe

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine create_energy_grid_ismabsfe(emin, emax, en, nen)
...
end subroutine create_energy_grid_ismabsfe
