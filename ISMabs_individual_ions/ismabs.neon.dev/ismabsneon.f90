...
! 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
subroutine ismabsneon(ear, ne, param, ifl, photar)
!
! The main routine to call all subroutines
!
implicit none
integer,parameter :: num_param = 11, out_unit=20, nion=10
...
version='1.0'
 if(startup)then
  print *, ' '
  print *, 'ISMabs_neon: ISM absorption model Version ',version 
  print *, 'NOTE: this model does not include hydrogen or helium, only Ne'       
  print *, ' '
  call read_cross_sections_ismabsneon( nemod,bxs,ifl)
  call create_energy_grid_ismabsneon(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
! Model parameters
N_N_1 = param(1)
...
call absorption_ismabsneon(N_N_1, N_N_2, &
N_N_3, N_N_4, N_N_5, N_N_6, N_N_7, N_N_8, & 
N_N_9, N_N_10, & 
zfac, emod, nemod, coemod,bxs,cion,ifl,bener)

call map_to_grid_ismabsneon(dble(ear),ne,emod,nemod,photar,coemod,ifl)
return
end subroutine ismabsneon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections_ismabsneon(bnene, xs, ifl)
  !---------------------------------------------------------------------
  ! Reads all cross sections and maps them onto a defined energy grid.
  ! Looks for the file at:
  !     <ismabsneon_root>/atomic_data/AtomicData.fits
  !---------------------------------------------------------------------
  ...
  character(len=1024) :: local_dir1, local_dir2, ismabsneon_root, filename2
  ...
  local_dir2 = 'smabs.neon.dev'
  ismabsneon_root = trim(local_dir1) // trim(local_dir2)
  filename2 = trim(ismabsneon_root) // fileloc
...
end subroutine read_cross_sections_ismabsneon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine absorption_ismabsneon(N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6,  N_N_7, &
				  N_N_8, N_N_9, N_N_10, &
...
end subroutine absorption_ismabsneon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine map_to_grid_ismabsneon(new_en, nne, old_en, one, nflux, old_flu, ifl)
  ...
  do i = 1, nne
     ...
     call dbinsrch_ismabsneon(new_en(i - 1), bmin, old_en, one + 1)
     call dbinsrch_ismabsneon(new_en(i), bmax, old_en, one + 1)
     bmin = bmin - 1
     bmax = bmax - 1
...
end subroutine map_to_grid_ismabsneon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine dbinsrch_ismabsneon(e, k, ener, n)
  ...
  k = klo
end subroutine dbinsrch_ismabsneon

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine create_energy_grid_ismabsneon(emin, emax, en, nen)
...
end subroutine create_energy_grid_ismabsneon
