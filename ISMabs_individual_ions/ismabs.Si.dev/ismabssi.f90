...
! 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
subroutine ismabssi(ear, ne, param, ifl, photar)
!
...
version='1.0'
 if(startup)then
  ...
  print *, ' '
  call read_cross_sections_ismabssi( nemod,bxs,ifl)
  call create_energy_grid_ismabssi(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
! Model parameters
N_N_1 = param(1)
...
call absorption_ismabssi(N_N_1, N_N_2, &
N_N_3, N_N_4, N_N_5, N_N_6, N_N_7, N_N_8, & 
N_N_9, N_N_10, N_N_11, N_N_12,& 
N_N_13, N_N_14,& 
zfac, emod, nemod, coemod,bxs,cion,ifl,bener)

call map_to_grid_ismabssi(dble(ear),ne,emod,nemod,photar,coemod,ifl)
return
end subroutine ismabssi

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections_ismabssi(bnene, xs, ifl)
  !---------------------------------------------------------------------
  ! Reads all cross sections and maps them onto a defined energy grid.
  ! Looks for the file at:
  !     <ismabssi_root>/atomic_data/AtomicData.fits
  !---------------------------------------------------------------------
  use xsfortran
  implicit none
  ...
  character(len=1024) :: local_dir1, local_dir2, ismabssi_root, filename2
  ...
  local_dir2 = 'smabs.Si/v1.1'
  ismabssi_root = trim(local_dir1) // trim(local_dir2)
  filename2 = trim(ismabssi_root) // fileloc
...
end subroutine read_cross_sections_ismabssi

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine absorption_ismabssi(N_N_1, N_N_2, N_N_3, N_N_4, N_N_5, N_N_6,  N_N_7, &
...
end subroutine absorption_ismabssi

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine map_to_grid_ismabssi(new_en, nne, old_en, one, nflux, old_flu, ifl)
  ...
  do i = 1, nne
     ...
     call dbinsrch_ismabssi(new_en(i - 1), bmin, old_en, one + 1)
     call dbinsrch_ismabssi(new_en(i), bmax, old_en, one + 1)
     bmin = bmin - 1
     bmax = bmax - 1
...
end subroutine map_to_grid_ismabssi

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine dbinsrch_ismabssi(e, k, ener, n)
  ...
  k = klo
end subroutine dbinsrch_ismabssi

! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine create_energy_grid_ismabssi(emin, emax, en, nen)
...
end subroutine create_energy_grid_ismabssi
